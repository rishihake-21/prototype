                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-200 rounded-xl p-5 xl:p-6 sticky top-8 space-y-5">
                    ...
                    <div class="border-t border-gray-100 pt-4">
                        ...
                        <div class="mt-3 space-y-3 text-sm text-gray-600">
                            <p><span class="font-semibold text-gray-900">1.</span> Confirm selected courses have moved into assignments.</p>
                            <p><span class="font-semibold text-gray-900">2.</span> Track submitted syllabi in the review queue.</p>
            ...
            <div class="min-w-0 space-y-6">
                ...
                <div id="selected-assignments" class="bg-white overflow-hidden shadow-sm ring-1 ring-gray-200 rounded-xl">
                    <div class="px-5 sm:px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900">Selected Assignments</h3>
                        <p class="text-sm text-gray-500 mt-1">Courses already taken forward by HOD, including elective pool selections.</p>
                    </div>
                    <div class="p-5 sm:p-6">
                        ...
                        @else
                            <div class="py-12 text-center text-gray-500">
                                No selected assignments are active yet.
                            </div>
                        @endif
                    </div>
                </div>
