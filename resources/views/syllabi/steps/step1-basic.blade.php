<div class="space-y-6">
    ...
    <div>
        ...
        <select x-model="form.program_name" @change="onProgrammeChange()" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
    ...
    <div>
        ...
        <input type="text" x-model="form.title" @input="updatePreview()" @keydown.enter.prevent
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" x-model="form.course_code" @input="onCourseCodeChange()" @keydown.enter.prevent maxlength="20"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
        ...
        <div>
            ...
            <select x-model="detectedLevel" @change="onManualLevelChange()" 
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
    ...
    <div>
        ...
        <input type="text" x-model="form.academic_year" @input="updatePreview()" @keydown.enter.prevent
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
    ...
    <div>
        ...
        <select multiple x-model="form.department_ids" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" size="4">
    ...
    <div x-show="detectedLevel === 3" class="bg-green-50 p-4 rounded-md space-y-3">
        <div>
            ...
            <select x-model="form.elective_group" @change="updatePreview()" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
